			...
			if (layEvent === 'detail') { // 查看
				layer.open({
					  ...
					  success: function(layero,index){
					    ...
					    body.find("input[name=seatnum]").val(data.seatnum);
					    body.find("input[name=reseatnum]").val(data.reseatnum);
					    body.find("input[name=fStarttime]").val(layui.util.toDateString(data.fStarttime,"yyyy-MM-dd HH:mm:ss"));
					    body.find("input[name=fEndtime]").val(layui.util.toDateString(data.fEndtime,"yyyy-MM-dd HH:mm:ss"));
					  }
				});  
			}
		});
