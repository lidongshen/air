    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {type: 'numbers', field: 'b_id', title: 'ID', sort: true, fixed: 'left'}
                , {field: 'b_name', align: 'center', title: '营业点名称'}
                , {field: 'b_phone', align: 'center', title: '营业点电话'}
                , {field: 'b_city', align: 'center', title: '所在城市', sort: true}
                , {
                    field: 'date',
                    title: '销售时间',
                    sort: true,
